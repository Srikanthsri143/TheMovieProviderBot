...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001728906556') # support group id ( make sure bot is admin )
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001728906556') # request channel id ( make sure bot is admin )
